...
function get_data($url,$provider,$start=0,$isAboveTheFold=0) {
/*
=========================================================================================================================
HTTP status code of cURL:                                                                                            
...
switch ($provider) {
    ...
    case 'AMAZON':
        ...
        $url = $url."?pg=$start&ajax=1&isAboveTheFold=$isAboveTheFold";
        //open connection
        $ch = curl_init();
        $timeout = 0;
        curl_setopt($ch, CURLOPT_URL, $url);
